    ...
    public void ImageClick(View v){
        ...
        switch (clickValue){
            case R.id.imageView1:
                sendBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.image1);
                break;
            case R.id.imageView2:
                sendBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.image2);
                break;
            ...
            case R.id.imageView6:
                sendBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.image6);
                break;
